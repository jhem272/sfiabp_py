...
**20180927ordered_df_pv_m.pkl** : In addition we provide the first 100 frames of the experimental data set A ( [Iwasawa et al. Phys. Rev. Research, 3:043104, 2021](https://journals.aps.org/prresearch/abstract/10.1103/PhysRevResearch.3.043104) ) discussed in the article. Active velocity U = 9.5 um/s, rotational diffusion Dr = 0.08 rad/s^2,  (‘dtframe’ = 1/15 s,  ‘xframelim’ = [0,420] um,  ‘yframelim’ = [0,336] um, recommended cell dimension ‘lcell’ = 21 um) 
